...
Cada transición individual registra `operationalEvents` con tipo, timestamp de servidor, resumen sanitizado y actor derivado de la sesión (email enmascarado). Los campos de pago, total, ítems, stock aplicado e identificadores históricos de proveedores no son editables desde el panel.
