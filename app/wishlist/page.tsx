...
export default function WishlistPage() {
  ...
  useEffect(() => {
    const storedWishlist = readWishlist(localStorage.getItem(WISHLIST_STORAGE_KEY));
    queueMicrotask(() => {
