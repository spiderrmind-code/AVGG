...
type Order = { _id: string; orderNumber?: string; items: Array<{ _id: string; name: string; price: number; quantity: number }>; total: number; currency: string; status: string; paymentStatus: string; customerEmailMasked?: string };
